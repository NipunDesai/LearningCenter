...
describe("CreateELearningContentControllerSpec", () => {

    var scope,
        $controllerConstructor: ng.IControllerService,
        $qService,
        createELearningContentController,
        defered,
        log,
        location,
        mockedeLearningContentService,
        http,
        window,
        routeParams,
        modal,
    ...
    it("Should get content creator name", () => {
    ...
    it("Should not get content creator name if content is deleted", () => {
        routeParams.cid = 1;
        var content = new Object();
    ...
    it("Should create elearning content", () => {
        var content = new Object();
        content["CreatedOn"] = "Pooja Shah";
    ...
    it("Should get elearninglecture list", () => {
    ...
    it("Should not add lecture without title", () => {
    ...
    it("Should not add same lecture title", () => {
    ...
    it("should bind lecturename when edit lecture", () => {
        var title = "Title";
    ...
    it("should update lecture title", () => {
    ...
    it("Should not add section without section title", () => {
    ...
    it("shuld not enter same section title", () => {
    ...
    it("should bind section name when edit section", () => {
        var title = "Title";
    ...
    it("Should atleat one lecture popup display", () => {
    ...
    it("Should atleat one section in every lecture popup display", () => {
    ...
    it("Should atleat one section content in every section popup display", () => {
    ...
    it("Should call editData broadcast", () => {
    ...
    it("Should call clearData broadcast", () => {
        spyOn(rootScope, "$broadcast");
        scope.cancelEditor();
        expect(rootScope.$broadcast).toHaveBeenCalled();
    ...
    it("should bind youtube link when link edit ", () => {
        var youtubeLink = "https://www.youtube.com/watch?v=OSP7o4lzIoQ";
        var sectionPageId = 1;
    ...
    it("should add interactive question", () => {
    ...
    it("should not add interactive question without question text", () => {
        var interactive = new Model.Interactive();
        interactive.ELearningSectionId = 1;
    ...
    it("should not add interactive question without topic name", () => {
        var interactive = new Model.Interactive();
        interactive.ELearningSectionId = 1;
        interactive.QuestionText = "question";
        var topicName = "";
    ...
    it("should add interactive parent option", () => { 
    ...
    it("should not add interactive parent option without entering text", () => {
        var interactive = new Model.Interactive();
        interactive.InteractiveQuestionId = 1;
    ...
    it("should add interactive child option", () => {
        var tree = new Object();
    ...
    it("should not add interactive child option without entering text", () => {
        var interactive = new Model.Interactive();
        interactive.InteractiveQuestionId = 1;
        interactive.interactiveOptionText = "";
        var currentNode = { collapsed: false, id: 1, name: "Option", parent: true, children: [] };
    ...
    it("should bind interactive tree for edit", () => {
        var sectionPageId = 1;
    ...
    it("should visible preview panel", () => {
        scope.preview();
        scope.$root.$apply();
        expect(scope.isPreview).toBeTruthy();
