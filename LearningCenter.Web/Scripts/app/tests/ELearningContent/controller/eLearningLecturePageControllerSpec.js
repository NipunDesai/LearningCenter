...
"user strict";
describe("eLearningLectureControllerSpec", function () {
    var scope, $controllerConstructor, log, location, routeParams, sce, eLearningLectureMockupservices, defered, rootScope, $qService, eLearningLecturePageController;
    beforeEach(angular.mock.module("app"));
    beforeEach(inject(function ($controller, $rootScope, $log, $q, $location, $routeParams, $sce, eLearningLecturePageService) {
    ...
    it("Should Be Get All ELearningLeacturePage", function () {
        var sectionId = 1;
...
//# sourceMappingURL=eLearningLecturePageControllerSpec.js.map