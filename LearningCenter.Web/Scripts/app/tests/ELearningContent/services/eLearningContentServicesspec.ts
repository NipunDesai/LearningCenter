...
describe("eLearningContentServicesspec", () => {
    var eLearningContentMockservice,
        $qService: ng.IQService,
        httpBackend;
    beforeEach(angular.mock.module("app"));

    beforeEach(inject((eLearningContentservice,
        $q: ng.IQService,
  ...
  it("should call GET on api/ELearningContent/getELearningContentList to get all eLearning content.", () => {
    ...
    it("should call GET on api/ELearningContent/updateELearningContentRate to update content rate", () => {
    ...
    it("should call GET on 'api/ELearningContent/viewContentDetail' to get contentDetails by Contentid", () => {
        var id = 1;
    ...
    it("should call GET on 'api/ELearningContent/eLearningSectionDetail' to get eLearningSection Details.", () => {
        var id = 1;
    ...
    it("should call GET on 'api/ELearningContent/getELearningContentById' to get eLearning content.", () => {
        var id = 1;
    ...
    it("should call GET on 'api/ELearningContent/deleteELearningContentById' to Delete ELearning Content.", () => {
        var id = 1;
    ...
    it("should call GET on 'api/ELearningContent/getContentCreatorName' elearning content creator name.", () => {
        var content = new Model.Content();
    ...
    it("should call POST on 'api/ELearningContent/createContent' save elearning content.", () => {
        var content = new Model.Content();
        content.CreatedBy = "Pooja Shah";
    ...
    it("should call GET on ' api/values/IsProfileCreated' get current user profile info.", () => {
    ...
    it("should call POST on 'api/ELearningContent/AddLecture' create lecture.", () => {
    ...
    it("should call GET on 'api/ELearningContent/GetLectureListById' get elearning lecture list.", () => {
    ...
    it("should call POST on 'api/ELearningContent/AddSection' create section.", () => {
    ...
    it("should call GET on 'api/ELearningContent/DeleteLectureById' to Delete ELearning lecture.", () => {
        var lectureId = 1;
    ...
    it("should call POST on 'api/ELearningContent/SaveYouTubeLink' to save youtube link.", () => {
    ...
    it("should call GET on 'api/ELearningContent/DeleteSectionById' to delete elearning section.", () => {
        var sectionId = 1;
    ...
    it("should call GET on 'api/Interactive/AddInteractiveQuestion' to save interactive question.", () => {
    ...
    it("should call GET on 'api/Interactive/AddInteractiveOption' to save interactive option.", () => {
