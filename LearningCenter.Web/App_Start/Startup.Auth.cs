...
namespace LearningCenter.Web
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(LearningCenterDataContext.Create);
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                Provider = new CookieAuthenticationProvider
                {
                    ...
                    OnValidateIdentity = SecurityStampValidator.OnValidateIdentity<ApplicationUserManager, ELearningUser>(
            ...
            //app.UseLinkedInAuthentication("77g3ycvdz9swte", "yZ2ESsyEw51lWUGh");

            var linkedInOptions = new LinkedInAuthenticationOptions();
            
                
            linkedInOptions.ClientId = ConfigurationManager.AppSettings["likedInAPIKey"];
            linkedInOptions.ClientSecret = ConfigurationManager.AppSettings["linkedIdSecretKey"];
            ...
            //app.UseFacebookAuthentication(
            //    appId: "982923998385135",
            //    appSecret: "8d386db915feb17d35fe6f0bb349a99e"
            //    );
            ...
            facebookAuthenticationOptions.AppId = ConfigurationManager.AppSettings["fbAppID"];
            facebookAuthenticationOptions.AppSecret = ConfigurationManager.AppSettings["fbAppSecret"];
